...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF4 | Vlan4094 | 10.255.252.19 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_DC1-LEAF4B_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_DC1-LEAF4B_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
!
interface Ethernet1
   description P2P_DC1-SPINE6_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ipv6 enable
!
interface Ethernet5
   description MLAG_DC1-LEAF4B_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_DC1-LEAF4B_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| Loopback100 | DIAG_VRF_Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.1.14/32 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_APP_Zone | 192.168.255.14:12 | 12:12 | - | - | learned | 130-131 |
| Tenant_A_DB_Zone | 192.168.255.14:13 | 13:13 | - | - | learned | 140-141 |
| Tenant_A_NFS | 192.168.255.14:10161 | 10161:10161 | - | - | learned | 161 |
| Tenant_A_OP_Zone | 192.168.255.14:10 | 10:10 | - | - | learned | 110-111 |
| Tenant_A_VMOTION | 192.168.255.14:10160 | 10160:10160 | - | - | learned | 160 |
| Tenant_A_WEB_Zone | 192.168.255.14:11 | 11:11 | - | - | learned | 120-121 |
| Tenant_B_OP_Zone | 192.168.255.14:20 | 20:20 | - | - | learned | 210-211 |
| Tenant_C_OP_Zone | 192.168.255.14:30 | 30:30 | - | - | learned | 310-311 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_APP_Zone | 192.168.255.14:12 | connected |
| Tenant_A_DB_Zone | 192.168.255.14:13 | connected |
| Tenant_A_OP_Zone | 192.168.255.14:10 | connected |
| Tenant_A_WEB_Zone | 192.168.255.14:11 | connected |
| Tenant_B_OP_Zone | 192.168.255.14:20 | connected |
| Tenant_C_OP_Zone | 192.168.255.14:30 | connected |
...
router bgp 65107
   ...
   neighbor MLAG_PEER description DC1-LEAF4B
...
| -------------- | ----------------------- | ----------------------- |
| Tenant_A_OP_Zone | 10.255.1.14 | - |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.255.1.14
```
