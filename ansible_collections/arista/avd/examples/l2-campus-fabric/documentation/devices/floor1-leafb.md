...
| --------- | --------------- | ------------ | --------- |
| floor1-leafs | Vlan4094 | 169.254.0.0 | Port-Channel51 |
...
| Ethernet51 | MLAG_PEER_floor1-leafa_Ethernet51 | *trunk | *- | *- | *['MLAG'] | 51 |
| Ethernet52 | MLAG_PEER_floor1-leafa_Ethernet52 | *trunk | *- | *- | *['MLAG'] | 51 |
| Ethernet53/1 | SPINE1_Ethernet2 | *trunk | *110,120,130,3000 | *- | *- | 531 |
| Ethernet53/2 | FLOOR1-MEMBER1_Ethernet26 | *trunk | *110,120,130,3000 | *- | *- | 532 |
| Ethernet54/1 | SPINE2_Ethernet2 | *trunk | *110,120,130,3000 | *- | *- | 531 |
| Ethernet54/2 | FLOOR1-MEMBER2_Ethernet26 | *trunk | *110,120,130,3000 | *- | *- | 542 |
...
interface Ethernet51
   description MLAG_PEER_floor1-leafa_Ethernet51
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description MLAG_PEER_floor1-leafa_Ethernet52
   no shutdown
   channel-group 51 mode active
!
...
interface Ethernet53/2
   description FLOOR1-MEMBER1_Ethernet26
   no shutdown
...
interface Ethernet54/2
   description FLOOR1-MEMBER2_Ethernet26
   no shutdown
   channel-group 542 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel51 | MLAG_PEER_floor1-leafa_Po51 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
| Port-Channel531 | SPINES_Po1 | switched | trunk | 110,120,130,3000 | - | - | - | - | 531 | - |
| Port-Channel532 | FLOOR1-MEMBER1_Po25 | switched | trunk | 110,120,130,3000 | - | - | - | - | 532 | - |
| Port-Channel542 | FLOOR1-MEMBER2_Po25 | switched | trunk | 110,120,130,3000 | - | - | - | - | 542 | - |
...
interface Port-Channel51
   description MLAG_PEER_floor1-leafa_Po51
   no shutdown
   switchport
...
interface Port-Channel532
   description FLOOR1-MEMBER1_Po25
   no shutdown
   switchport
   switchport trunk allowed vlan 110,120,130,3000
   switchport mode trunk
   mlag 532
!
interface Port-Channel542
   description FLOOR1-MEMBER2_Po25
   no shutdown
   switchport
   switchport trunk allowed vlan 110,120,130,3000
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan3000 |  IB_MGMT  |  11.11.11.5/24  |  -  |  -  |  -  |  -  |  -  |
