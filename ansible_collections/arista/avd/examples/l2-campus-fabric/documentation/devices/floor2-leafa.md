...
| -------- | --------- | ---------- | ---------- | --- | ------ | ---- | --------------- |
| 00:1C:73:7f:00:06 | - | 127 | 6 | - | 127 | boundary | - |

#### PTP Device Configuration

```eos
!
ptp clock-identity 00:1C:73:7f:00:06
ptp priority1 127
ptp priority2 6
ptp domain 127
ptp mode boundary
...
| --------- | --------------- | ------------ | --------- |
| floor2-leafs | Vlan4094 | 169.254.0.11 | Port-Channel51 |
...
| Ethernet51 | MLAG_PEER_floor2-leafb_Ethernet51 | *trunk | *- | *- | *['MLAG'] | 51 |
| Ethernet52 | MLAG_PEER_floor2-leafb_Ethernet52 | *trunk | *- | *- | *['MLAG'] | 51 |
| Ethernet53/1 | SPINE1_Ethernet3 | *trunk | *210,220,230,3000 | *- | *- | 531 |
| Ethernet53/2 | FLOOR2-MEMBER1_Ethernet25 | *trunk | *210,220,230,3000 | *- | *- | 532 |
...
interface Ethernet51
   description MLAG_PEER_floor2-leafb_Ethernet51
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description MLAG_PEER_floor2-leafb_Ethernet52
   no shutdown
   channel-group 51 mode active
!
...
interface Ethernet53/2
   description FLOOR2-MEMBER1_Ethernet25
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel51 | MLAG_PEER_floor2-leafb_Po51 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel51
   description MLAG_PEER_floor2-leafb_Po51
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan3000 |  IB_MGMT  |  11.11.11.9/24  |  -  |  -  |  -  |  -  |  -  |
