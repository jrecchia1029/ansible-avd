...
| Ethernet25 | FLOOR1-LEAFA_Ethernet53/2 | *trunk | *110,120,130,3000 | *- | *- | 25 |
| Ethernet26 | FLOOR1-LEAFB_Ethernet53/2 | *trunk | *110,120,130,3000 | *- | *- | 25 |
| Ethernet27 | FLOOR1-MEMBER3_Ethernet17 | *trunk | *110,120,130,3000 | *- | *- | 27 |
...
interface Ethernet25
   description FLOOR1-LEAFA_Ethernet53/2
   no shutdown
   channel-group 25 mode active
!
interface Ethernet26
   description FLOOR1-LEAFB_Ethernet53/2
   no shutdown
   channel-group 25 mode active
!
interface Ethernet27
   description FLOOR1-MEMBER3_Ethernet17
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel25 | FLOOR1-LEAFS_Po532 | switched | trunk | 110,120,130,3000 | - | - | - | - | - | - |
| Port-Channel27 | FLOOR1-MEMBER3_Po17 | switched | trunk | 110,120,130,3000 | - | - | - | - | - | - |
...
interface Port-Channel25
   description FLOOR1-LEAFS_Po532
   no shutdown
   switchport
...
interface Port-Channel27
   description FLOOR1-MEMBER3_Po17
   no shutdown
   switchport
   switchport trunk allowed vlan 110,120,130,3000
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan3000 |  IB_MGMT  |  11.11.11.6/24  |  -  |  -  |  -  |  -  |  -  |
