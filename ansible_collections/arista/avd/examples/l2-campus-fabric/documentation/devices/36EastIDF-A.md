...
| -------- | --------- | ---------- | ---------- | --- | ------ | ---- | --------------- |
| 00:1C:73:7f:00:03 | - | 127 | 3 | - | 127 | boundary | - |
...
| --------- | --------------- | ------------ | --------- |
| 36East | Vlan4094 | 192.168.0.5 | Port-Channel58 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | SPLINE1_Ethernet2 | *trunk | *700 | *- | *- | 49 |
| Ethernet51 | 36EASTIDF-MEMBER1_Ethernet51 | *trunk | *700 | *- | *- | 51 |
| Ethernet52 | 36EASTIDF-MEMBER2_Ethernet51 | *trunk | *700 | *- | *- | 52 |
| Ethernet58 | MLAG_PEER_36EastIDF-B_Ethernet58 | *trunk | *- | *- | *['MLAG'] | 58 |
| Ethernet59 | MLAG_PEER_36EastIDF-B_Ethernet59 | *trunk | *- | *- | *['MLAG'] | 58 |
...
interface Ethernet49
   description SPLINE1_Ethernet2
   no shutdown
   channel-group 49 mode active
!
interface Ethernet51
   description 36EASTIDF-MEMBER1_Ethernet51
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description 36EASTIDF-MEMBER2_Ethernet51
   no shutdown
   channel-group 52 mode active
!
interface Ethernet58
   description MLAG_PEER_36EastIDF-B_Ethernet58
   no shutdown
   channel-group 58 mode active
!
interface Ethernet59
   description MLAG_PEER_36EastIDF-B_Ethernet59
   no shutdown
   channel-group 58 mode active
```
...
| Port-Channel58 | MLAG_PEER_36EastIDF-B_Po58 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel58
   description MLAG_PEER_36EastIDF-B_Po58
   no shutdown
   switchport
   switchport mode trunk
